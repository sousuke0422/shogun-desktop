# E2E: taskbar-button progress (OSC 9;4 Phase 2) against a live build.
...
# Taskbar button strip: left part of the bottom taskbar (buttons live there).
$screen = [System.Windows.Forms.Screen]::PrimaryScreen.Bounds
function Save-Buttons([string]$name) {
    $w = 2600; $h = 60
    $y = $screen.Bottom - $h
...
Save-Buttons 'tbp0-before.png'
Run-Cmd 'printf "\033]9;4;1;50\007"'
Start-Sleep -Seconds 2
Save-Buttons 'tbp1-normal50.png'
Run-Cmd 'printf "\033]9;4;3;\007"'
Start-Sleep -Seconds 2
Save-Buttons 'tbp2-indeterminate.png'
Run-Cmd 'printf "\033]9;4;0;\007"'
Start-Sleep -Seconds 2
Save-Buttons 'tbp3-cleared.png'
