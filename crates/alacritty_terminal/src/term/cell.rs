...
bitflags! {
    ...
    pub struct Flags: u16 {
        ...
        // PATCHED (shogun-desktop): upstream alacritty drops SGR 5/6 (text
        // blink) entirely. One flag covers both speeds — the last free u16
        // bit — matching terminals that render slow/rapid identically.
